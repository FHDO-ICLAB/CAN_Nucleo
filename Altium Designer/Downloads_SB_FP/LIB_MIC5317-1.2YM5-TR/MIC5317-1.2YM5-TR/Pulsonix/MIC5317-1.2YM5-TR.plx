...
(library Library_1
	...
	(symbolDef "MIC5317-1.2YM5-TR" (originalName "MIC5317-1.2YM5-TR")
	...
	(compDef "MIC5317-1.2YM5-TR" (originalName "MIC5317-1.2YM5-TR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MIC5317-1.2YM5-TR"))
		...
		(attr "<Hyperlink>" "http://www.microchip.com/mymicrochip/filehandler.aspx?ddocname=en579427")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "MIC5317-1.2YM5-TR.stp")
